...
algosArr = ['UCT','UCTie','UCTnancy','UCTS','UCTSie','UCTSnancy','GUCT','GUCTie','GUCTnancy','GUCTS','GUCTSie','GUCTSnancy', 'WAS', 'WASie', 'WASnancy' ,'RISK','FHAT','IE','LSSLRTA']
algosArr = ['UCT','UCTie','UCTnancy','UCTS','UCTSie','UCTSnancy', 'WAS', 'WASie', 'WASnancy' ,'RISK','FHAT','IE','LSSLRTA']
...
def pointplot(df, n, j, title):
    sns.set(rc={'figure.figsize': (24, 14), 'font.size': 14, 'text.color': 'black'})
    ax = sns.pointplot(x='Lookahead', y='SolCost', data=df, hue = 'Algorithm', dodge=0.6, join=j, markers=markerList, errwidth=3, ci=95)
