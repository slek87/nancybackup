    ...
    then
        ...
        do
            ...
            then 
                ...
                then
                    timeout 2700 ../../build_release/trialBasedTest2 ${domainType} ${lookahead} ${algorithm}   ../../results/${algorithm}2/${domainType}/${dimensions}x${dimensions}/LA${lookahead}/${instance}-${dimensions}x${dimensions}.csv < ${file}
                else
                    timeout 2700 ../../build_release/${algorithm}expansionTest ${domainType} ${lookahead}  ../../results/${algorithm}2/${domainType}/${dimensions}x${dimensions}/LA${lookahead}/${instance}-${dimensions}x${dimensions}.csv < ${file}
                fi
    ...
    then
        ...
        do
            ...
            then 
                ...
                if [[ $algorithm == *"UCT"* ]] || [[ $algorithm == *"WAS"* ]]
                then
                    timeout 2700 ../../build_release/trialBasedTest2 ${domainType} ${lookahead} ${algorithm}   ../../results/${algorithm}2/${domainType}/LA${lookahead}/b2d100-${instance}.csv < ${file}
                else
                    timeout 2700 ../../build_release/${algorithm}expansionTest ${domainType} ${lookahead}  ../../results/${algorithm}2/${domainType}/LA${lookahead}/b2d100-${instance}.csv < ${file}
                fi
    ...
    then
        ...
        do
            ...
            then 
                ...
                if [[ $algorithm == *"UCT"* ]] || [[ $algorithm == *"WAS"* ]]
                then
                    timeout 2700 ../../build_release/trialBasedTest2 ${domainType} ${lookahead} ${algorithm}   ../../results/${algorithm}2/${domainType}/${dimensions}/LA${lookahead}/${instance}-${dimensions}.csv < ${file}
                else
                    timeout 2700 ../../build_release/${algorithm}expansionTest ${domainType} ${lookahead}  ../../results/${algorithm}2/${domainType}/${dimensions}/LA${lookahead}/${instance}-${dimensions}.csv < ${file}
                fi
