...
do
    ...
    then
        ...
        do
            ...
            if [ -f ../../results/${algorithm}/${domainType}/${dimensions}x${dimensions}/LA${lookahead}/${instance}-${dimensions}x${dimensions}.csv ] || [ -f ../../results/${trialAlgorithm}/${domainType}/${dimensions}x${dimensions}/LA${lookahead}/${instance} ]
            then 
                let instance++
            else
