...
resultDirs = {"10"}
limits = [100, 300, 1000, 3000, 10000, 30000]
...
for dir in resultDirs:
    for file in listdir("/export/home/slk56/results/" +  domain + "/expansionTests/Nancy/" + dir):
        with open("/export/home/slk56/results/" + domain + "/expansionTests/Nancy/" + dir + "/" + file) as json_data:
