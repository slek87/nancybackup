...
#include <string>
#include <fstream>
#include "TrialBasedRealTimeSearchL.h"
...
int main(int argc, char** argv) {
    ...
    string result = algorithm + "2" + "," + domain + "," + to_string(res.solutionCost) + "," + to_string(res.nodesGenerated) + "," + to_string(res.nodesExpanded) + "," + to_string(lookahead);
