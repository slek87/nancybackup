...
public:
    ...
    void performTrial(unordered_map<State, shared_ptr<Node>, Hash>& TT){
        PQueue backupQueue;
    ...
    void selectActionOnBestF(shared_ptr<Node>& n){
