...
do
    ...
    then
        ...
        ./trialtest.sh 50 10 2 SlidingPuzzle ${algo} ${dec}
        ./trialtest.sh 50 10 2 HeavyTile ${algo} ${dec}
        ./trialtest.sh 500 100 2 TreeWorld ${algo} ${dec}
    ...
    then
        ...
        ./trialtest.sh 180 21 2 Pancake ${algo} ${dec} 10  
        ./trialtest.sh 180 21 2 PancakeDPS ${algo} ${dec} 10  
    fi
    cd ..
done
